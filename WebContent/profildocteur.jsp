...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
    ...
    <div class="container emp-profile">
             <form action="<%=request.getContextPath()%>/profildocteur?username=${sessionScope.username}" method="Post">
                    ...
                    <div class="col-md-8">
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                       ...
                                       <center><a href ="editprofildocteur?idchercheur=<c:out value='${cher2.idchercheur}'/>" class="btn btn-success " role="button" >Modifier</a></center>
                            </div>
