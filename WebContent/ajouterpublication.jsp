...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold"> <p style="color:black;"><c:out value="${mdpInco}"/></p></span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Juin 20, 2022</div>
                                       <strong> vous avez supprimer une publication</strong>
                                    </div>
                                </a>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Publication</h2></a></li>
                                
                            </ul>


               <form action="<%=request.getContextPath()%>/ajouterpublication" method="Post"  enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <label>Type Publication</label>
                                                             <div class="form-group">
                                                                       ...
                                                                       <select name="type_pub" class="form-group col-lg-8" >
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="titre" type="text" class="form-control" placeholder="Titre Publication">
                                                                </div>
                                                                 <div class="form-group">
                                                                <label>Date Publication  :</label>
                                                                    <input name="date" type="Date" class="form-control" placeholder="Date Soutenance">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <input name="auteur" type="text" class="form-control" placeholder="Auteur Publication">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group col-lg-6">
                                                                     <label>Selectionner un Chercheur  </label>
                                                                     
                                                                       <select name="username" class="form-group col-lg-8" >
                                                                       
                                                                         <c:forEach items="${chercheures}" var="cher">
                                                                          <option>${cher.username}</option>
                                                                          </c:forEach>                                                                   
                                                                      </select>
