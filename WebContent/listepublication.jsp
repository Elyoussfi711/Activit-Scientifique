        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                     <form action="<%=request.getContextPath()%>/listepublication" method="Post">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                       <tr>
                                  <c:forEach items="${activitess}" var="activites">
                                   <c:set var="count" value="${count + 1}" scope="page"/>
                                            <td>${count}</td>
                                            <td>${activites.type_pub}</td>
                                            <td>${activites.titre}</td>
                                            <td>${activites.date}</td>
                                            <td>${activites.auteur}</td>
                                            <td>${activites.description}</td>
                                            <td>${activites.a_bstract}</td>
                                            ...
                                            <td>
                                                ...
                                                <br></br>
                                                <a href="deletepublication?idactivitesc=<c:out value='${activites.idactivitesc}'/>" ><i class='fas fa-trash-alt' style='font-size:20px;color:#D33C08'></i></a></td>
