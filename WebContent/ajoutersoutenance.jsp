...
<form action="<%=request.getContextPath()%>/ajoutersoutenance" method="Post" enctype="multipart/form-data">
 ...
 <div class="form-group col-lg-6">
                                                                     <label>Type :</label>
                                                                     <br><br>
                                                                         <select name="type_sout" class="form-group col-lg-8" >
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <label>Date Soutenance :</label>
                                                                 ...
                                                                 <div class="form-group">
                                                                    <input name="initule" type="text" class="form-control" placeholder="Intitule Publication">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <input name="lieu" type="text" class="form-control" placeholder="Lieu Soutenance">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="jury" type="text" class="form-control" placeholder="Jury Soutenenace">
                                                                </div>
                                                                <div class="form-group">
