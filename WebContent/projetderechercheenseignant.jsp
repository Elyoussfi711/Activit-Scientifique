...
<head>
    <meta charset="utf-8">
    <title>projet de recherche enseignant</title>
               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/projetderechercheenseignant?username=${sessionScope.username}" method="Post" enctype="multipart/form-data">
                                ...
                                <input name="titre" type="text" class="form-control" id="floating"
                                    ...
                                    <h6>    </h6>
                                     ...
                                     <h6>Budget Projet :</h6>
                                <input name="budget" type="text" class="form-control" id="floating"
                                    placeholder="Budget Projet">
                                    <h6>    </h6>
                                     
                                     <h6>Duree Projet :</h6>
                                <input name="duree" type="text" class="form-control" id="floating"
                                    placeholder="Duree Projet">
                                    <h6>    </h6>
