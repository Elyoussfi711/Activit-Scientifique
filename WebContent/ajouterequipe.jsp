...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Equipe</h2></a></li>
                                                    ...
                                                    <form action="<%=request.getContextPath()%>/ajouterequipe" method="Post">
                                                   ...
                                                   <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="nom_equipe" type="text" class="form-control" placeholder="Nom Equipe">
                                                                </div>
                                                                
                                                                <div class="form-group col-lg-6">
                                                                     <label>Selectionner  Chef D'Equipe : </label>
                                                                     
                                                                       <select name="chef_equipe" class="form-group col-lg-8" >
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<select name="username1" class="form-group col-lg-8" >
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<select name="username2" class="form-group col-lg-8" >
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<select name="username3" class="form-group col-lg-8" >
