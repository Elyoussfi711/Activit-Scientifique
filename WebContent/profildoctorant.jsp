...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="imagess/${cher2.image}" alt="" style="width: 40px; height: 40px;">
               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="imagess/${cher2.image}" alt="" style="width: 40px; height: 40px;">
    ...
    <div class="container emp-profile">
             <form action="<%=request.getContextPath()%>/profildoctorant?username=${sessionScope.username}" method="Post">
            
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-img">
                             <img src="imagess/${cher2.image}" height ="200" width="200" alt="Image" />
                    ...
                    <div class="col-md-8">
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                       ...
                                       <center><a href ="editprofildoctorant?idchercheur=<c:out value='${cher2.idchercheur}'/>" class="btn btn-success " role="button" >Modifier</a></center>
                            </div>
