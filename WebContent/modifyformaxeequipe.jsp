...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="listechercheur.jsp">List Chercheur</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="listelaboratoire.jsp">List Laboratoires</a>
                    </div>
                </div>
            </li>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Axe Equipe</h2></a></li>
                                
                            </ul>


                                                
                                                    <form action="<%=request.getContextPath()%>/updateaxeequipe" method="Post">
                                                        <div class="row">
                                                           
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                               
                                                                <div class="form-group">
                                                                    <input name="nom_axe_equipe" type="text" class="form-control" value="${ana.nom_axe_equipe}"/>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                  ...
                                                                  <div class="form-group">
                                                                         <input type="hidden" class="form-input" name="id_axe_equipe" id="nom_axe_equipe" value="${ana.id_axe_equipe}"/>
