            ...
            <div id="content">
             ...
             <h3><strong><i><p style="color:#4d79ff"></br>
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form action="<%=request.getContextPath()%>/listesoutenance" method="Post"> 
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                  ...
                                  <c:forEach items="${soutenance}" var="sout">
                                   <c:set var="count" value="${count + 1}" scope="page"/>
                                            ...
                                            <td>${sout.a_bstract}</td>
                                            <td>
                                               
                                        <a href="deletesoutenance?idactivitesc=<c:out value='${sout.idactivitesc}'/>" ><i class='fas fa-trash-alt' style='font-size:20px;color:#D33C08'></i></a>
                                            <br></br>
                                            </td>
