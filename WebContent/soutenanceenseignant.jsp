...
<head>
    <meta charset="utf-8">
    <title>soutenance enseignant</title>
               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/soutenanceenseignant?username=${sessionScope.username}" method="Post"  enctype="multipart/form-data">
                                  <h6>Soutenance :</h6>
                            <select name="type_sout" class="form-select mb-3" aria-label="Default select example">
                             ...
                             <h6>    </h6>
                                ...
                                <input name="lieu" type="text" class="form-control" id="floating"
                                    placeholder="Lieu De Soutenance">
                                    <h6>    </h6>
                                     <h6>Jury de Soutenance :</h6>
                                <div  class="form-group">
                                                                    <input name="jury" type="text" class="form-control" placeholder="Jury Soutenance">
                                                                </div>
