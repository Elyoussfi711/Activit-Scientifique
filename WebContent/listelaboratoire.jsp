            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="listechercheur">List Equipes</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h3><strong><i><p style="color:#4d79ff"></br>
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->  
             <form action="<%=request.getContextPath()%>/listelaboratoire" method="Post">         
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                            ...
                                            <th>Chef Laboratoire</th>
                                            <th>Actions</th>
                                     </thead>
                                    
                                    <tbody>
                                       <tr>
                                  <c:forEach items="${laboratoire}" var="lab">
                                  <c:set var="count" value="${count + 1}" scope="page"/>
                                            ...
                                            <td>
                                               <a href ="editformelaboratoire?id_Laboratoire=<c:out value='${lab.id_Laboratoire}'/>"  ><i class='fas fa-wrench' style='font-size:24px;color:#E7E40D'></i></a>
                                                <a href="deletelaboratoire?id_Laboratoire=<c:out value='${lab.id_Laboratoire}'/>" ><i class='fas fa-trash-alt' style='font-size:20px;color:#D33C08'></i></a></td>
                                        </tr>
