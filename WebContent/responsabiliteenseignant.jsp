...
<head>
    <meta charset="utf-8">
    <title>responsabiliter enseignant</title>
               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/responsabiliteenseignant?username=${sessionScope.username}" method="Post"" method="Post">
                                  <h6>Type De Responsabilités :</h6>
                            <select name="responsabiliter"  class="form-select mb-3" aria-label="Default select example">
