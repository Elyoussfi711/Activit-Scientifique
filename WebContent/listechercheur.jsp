        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                  <form action="<%=request.getContextPath()%>/listechercheur" method="Post">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <p style="text-align: right;"> <a href="pdf" class="btn btn-secondary btn-xs" ><i
																class="fa fa-file-pdf-o" style="font-size:40px;color:black"></i></a></p>
                                    <thead>
                                      <th>ID</th>
                                            <th>Nom</th>
                                            <th>Prenom</th>
                                    ...
                                    <tbody>
                                  <tr>
                                  <c:forEach items="${Chercheurs}" var="Ch" >
                                  <c:set var="count" value="${count + 1}" scope="page"/>
                                            <td>${count}</td>
                                            <td>${Ch.username}</td>
                                            <td>${Ch.prenom}</td>
                                            <td>${Ch.email}</td>
                                            <td class="hidetext">${Ch.password}</td>
                                            <td>${Ch.tel}</td>
                                            <td>${Ch.profil}</td>
                                            ...
                                            <td>
                                                 <a href ="editformechercheur?idchercheur=<c:out value='${Ch.idchercheur}'/>"  ><i class='fas fa-wrench' style='font-size:24px;color:#E7E40D'></i></a>
                                                 </br>
                                                 <a href ="profilechercheuradmin?idchercheur=<c:out value='${Ch.idchercheur}'/>"><i class='fas fa-file-alt' style='font-size:20px'></i></a>
                                                 </br>
                                                <a href="deletechercheur?idchercheur=<c:out value='${Ch.idchercheur}'/>" ><i class='fas fa-trash-alt' style='font-size:20px;color:#D33C08'></i></a>
                                                </td>
                                           </tr>
