        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="ajouterequipe.jsp">Ajouter Equipes</a>
                        <a class="collapse-item" href="#">List Equipes</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ajouteraboratoire.jsp">Ajouter Laboratoires</a>
                        <a class="collapse-item" href="#">List Laboratoires</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
             ...
             <li class="nav-item">
                ...
                <div id="collapseTwo4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ajouterpublication.jsp">Ajouter Publicatios</a>
                        <a class="collapse-item" href="#">List Publications</a>
                    </div>
                </div>
            </li>
             ...
             <li class="nav-item">
                ...
                <div id="collapseTwo5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ajoutersoutenance.jsp">Ajouter Soutenances</a>
                        <a class="collapse-item" href="#">List Soutenances</a>
                    </div>
                </div>
            </li>
             ...
             <li class="nav-item">
                ...
                <div id="collapseTwo6" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ajouterconference.jsp">Ajouter Conference</a>
                        <a class="collapse-item" href="#">List Conference</a>
                    </div>
                </div>
            </li>
             ...
             <li class="nav-item">
                ...
                <div id="collapseTwo7" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ajouterproject.jsp">Ajouter Des Projet</a>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="home.jsp" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    <div class="text-center">
                        ...
                        <a href="adminpage.jsp">&larr; Back to Dashboard</a>
                    </div>
