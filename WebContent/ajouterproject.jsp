...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Projet De Recherche</h2></a></li>
                                
                            </ul>


                                                
                                                    <form action="<%=request.getContextPath()%>/ajouterproject" method="Post">
                                                 
                                                        <div class="row">
                                                           
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                <label>Date Projet de Recherche :</label>
                                                                    <input name="date" type="Date" class="form-control" placeholder="Date Projet de Recherche">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="titre" type="text" class="form-control" placeholder="Titre Projets">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <input name="budget" type="text" class="form-control" placeholder="Budget Projets">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="duree" type="text" class="form-control" placeholder="Duree Projets">
                                                                </div>
                                                                <div class="form-group">
