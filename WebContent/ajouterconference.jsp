...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Conference</h2></a></li>
                                
                            </ul>


                                                
                                                    <form action="<%=request.getContextPath()%>/ajouterconference" method="Post">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                               ...
                                                               <div class="form-group col-lg-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="initule" type="text" class="form-control" placeholder="Initule Conference">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <input name="date" type="Date" class="form-control" placeholder="Date Conference">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="lieu" type="text" class="form-control" placeholder="Lieu Conference">
                                                                </div>
                                                                <div class="form-group">
