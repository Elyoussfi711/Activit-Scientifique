               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/updatesoutenanceenseignant" method="Post">
                                  <h6>Soutenance :</h6>
                            <select name="type_sout" class="form-select mb-3" aria-label="Default select example" value="${nta.type_sout}"/>
