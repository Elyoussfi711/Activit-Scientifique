...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Laboratoire</h2></a></li>
                                                    ...
                                                    <form action="<%=request.getContextPath()%>/updatelaboratoire" method="Post">
                                                        <div class="row">
                                                           
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                               
                                                                <div class="form-group">
                                                                    <input name="nom_Labo" type="text" class="form-control" value="${nta.nom_Labo}">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <input name="chef_Labo" type="text" class="form-control" value="${nta.chef_Labo}">
                                                                </div>
                                                             </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                                ...
                                                                                <div class="form-group">
                                                                         <input type="hidden" class="form-input" name="id_Laboratoire" id="name" value="${nta.id_Laboratoire}"/>
