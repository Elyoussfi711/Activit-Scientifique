...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
             ...
             <li class="nav-item">
                ...
                <div id="collapseTwo4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ajouterpublication">Ajouter Publicatios</a>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Equipe</h2></a></li>
                                
                            </ul>


                                                
                                                    <form action="<%=request.getContextPath()%>/updateequipe" method="Post">
                                                   ...
                                                   <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="nom_equipe" type="text" class="form-control" value=${ana.nom_equipe } />
                                                                </div>
                                                                
                                                                <div class="form-group col-lg-6">
                                                                     <label>Selectionner  Chef D'Equipe : </label>
                                                                     
                                                                       <select name="chef_equipe" class="form-group col-lg-8" value=${ana.chef_equipe }>
                                                                       
                                                                         <c:forEach items="${enseignant}" var="ens">
                                                                          <option >${ens.username}</option>
                                                                          </c:forEach>                                                                   
                                                                      </select>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Ajouter chercheur 1 :<span class="required"></span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											
											
												<select name="username1" class="form-group col-lg-8" value=${ana.nomcher1 }>
													
													 
													<c:forEach items="${chercheures}" var="ch">
													<option  >${ch.username}</option>
													</c:forEach>
												</select>
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Ajouter chercheur 2 :<span class="required"></span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											
											
												<select name="username2" class="form-group col-lg-8" value=${ana.nomcher2 }>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Ajouter chercheur 3 :<span class="required"></span>
											</label>
											<div class="col-md-6 col-sm-6 ">
											
											
												<select name="username3" class="form-group col-lg-8" value=${ana.nomcher3 } />
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control"
													name="nom_axe_equipe" size="4" multiple required="1" >
													
													<c:forEach items="${axeequipe}" var="axe" >
													<option >${axe.nom_axe_equipe}</option>
													</c:forEach>
												</select>
											</div>
										</div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group col-lg-6">
                                                                     <label>Selectionner un Laboratoire  </label>
                                                                     
                                                                       <select name="nom_Labo" class="form-group col-lg-8" >
                                                                       
                                                                         <c:forEach items="${laboratoires}" var="lab">
                                                                          <option >${lab.nom_Labo}</option>
                                                                          </c:forEach>                                                                   
                                                                      </select>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                                ...
                                                                                <div class="form-group">
                                                                         <input type="hidden" class="form-input" name="idequipe" id="idacitivitesc" value="${ana.idequipe}"/>
