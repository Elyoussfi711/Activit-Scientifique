...
<head>
    <meta charset="utf-8">
    <title>conference doctorant</title>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                  <br></br>
                    ...
                    <a href="listepublicationdocteur?username=${sessionScope.username}" class="nav-item nav-link" >Liste  votre publication Publication  </a>
               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form  action="<%=request.getContextPath()%>/conferencedocteur?username=${sessionScope.username}" method="Post"  enctype="multipart/form-data">
                                  
                             <h6>    </h6>
                                <h6>Intitule Conference : </h6>
                                <input name="initule" type="text" class="form-control" id="floating"
                                    placeholder="Intitule Conference ">
                                    <h6>    </h6>
                                ...
                                <input name="date" type="Date" class="form-control" id="floating"
                                    ...
                                    <h6>    </h6>
                                     ...
                                     <h6>Lieu Conference</h6>
                                <input name="lieu"  type="text" class="form-control" id="floating"
                                    placeholder="Lieu Conference">
                                    <h6>    </h6>
                            ...
                            <h6>  </h6>
                               <h6>Description :</h6>
                                <div class="form-group">
                                                                    <textarea name="description" type="text" class="form-control" placeholder="Description Conference"></textarea>
                                                                </div>
