...
<head>
    <meta charset="utf-8">
    <title>soutenance docteur</title>
               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                          ...
                          <form action="<%=request.getContextPath()%>/updatesoutenancedocteur" method="Post">
                                  <h6>Soutenance :</h6>
                            <select class="form-select mb-3" aria-label="Default select example" name="type_sout" value="${nta.type_sout}" />
                             ...
                             <h6>    </h6>
                                <h6>Intitule :</h6>
                                <input type="text" class="form-control" id="floating" value="${nta.initule}" name="initule" />
                                 
                                    <h6>    </h6>

                                     <h6>Date</h6>
                                <input type="Date" class="form-control" id="floating" name="date" value="${nta.date}" />
                                    
                                    <h6>    </h6>

                                
                                     <h6>Lieu De Soutenance :</h6>
                                <input type="text" name="lieu" class="form-control" id="floating"  value="${nta.lieu}" />
                                    
                                    <h6>    </h6>
                                     <h6>Jury de Soutenance :</h6>
                                <div class="form-group">
                                                                    <input name="jury" type="text" class="form-control" value="${nta.jury}" />
                                                                </div>
                            ...
                            <br></br>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="Ajouter" class="btn btn-primary waves-effect waves-light">Modifier</button>
                                                                </div>
                                                            </div>
                                                                                            <div class="form-group">
