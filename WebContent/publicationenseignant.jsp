               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/publicationenseignant?username=${sessionScope.username}" method="Post"  enctype="multipart/form-data">
                                  
                             <h6>    </h6>
                                <h6>Titre Publication : </h6>
                                <input name="titre" type="text" class="form-control" id="floating"
                                    placeholder="Titre Publication">
                                    <h6>    </h6>

                                    <h6>Auteur Publication :</h6>
                                <input name="auteur" type="text" class="form-control" id="floating"
                                    placeholder="Auteur Publication">
                                    <h6>    </h6>
