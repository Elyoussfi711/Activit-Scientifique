...
<head>
    <meta charset="utf-8">
    <title>encadrement enseignant</title>
...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
               ...
               <ul class="nav navbar-nav mai-top-nav">
                      ...
                      <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/encadrementenseignant?username=${sessionScope.username}" method="Post" enctype="multipart/form-data">
                                  <h6>Encadrement :</h6>
                            <select name="titre_enc" class="form-select mb-3" aria-label="Default select example">
                              
                               
                                <option >PFE de Licence</option>
                                <option >PFE de Master</option>
                                <option >Thèse de Doctorat</option>
                                <option >Thèse D'habilitation</option>
                            </select>
                             <h6>    </h6>
                                <h6>Intitule :</h6>
                                <input name="initule" type="text" class="form-control" id="floating"
                                    placeholder="Intitule">
                                    <h6>    </h6>

                                
                                     <h6>Type D'encadrement :</h6>
                            <select  name="type_enc" placeholder="Encadrement" class="form-select mb-3" aria-label="Default select example ">
                              
                                
                                <option >Directeur de Thèse</option>
                                <option >Encadrant de Thèse</option>
                                <option >Co-encadrement de thèse</option>
                                
                            </select>
                             <h6>Date de Publication :</h6>
                                <input name="date" type="Date" class="form-control" id="floating">
                                </br>
                               <h6>Descrption Sur L'encadrement :</h6>
                                <div class="form-group">
                                                                    <textarea name="description" type="text" class="form-control" placeholder="Description Publication"></textarea>
                                                                </div>
                                    
                            
                                 <h6>    </h6>
                                 <h6>Justification :</h6>
                                <input name="justificatif" class="form-control" type="file" id="formFile">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js1/bootstrap.bundle.min.js"></script>
