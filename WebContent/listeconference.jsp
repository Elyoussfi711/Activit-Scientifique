...
<ul class="nav navbar-nav mai-top-nav">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                         <form action="<%=request.getContextPath()%>/listeconference" method="Post"> 
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                  ...
                                  <c:forEach items="${conference}" var="confer">
                                   <c:set var="count" value="${count + 1}" scope="page"/>
                                            <td>${count}</td>
                                            <td>${confer.initule}</td>
                                            <td>${confer.date}</td>
                                            <td>${confer.lieu}</td>
                                            <td>${confer.description}</td>
                                            <td>${confer.a_bstract}</td>
                                            <td>NULL</td>
                                            
                                            <td>
                                               
                                            <a  href="deleteconference?idactivitesc=<c:out value='${confer.idactivitesc}'/>" ><i class='fas fa-trash-alt' style='font-size:20px;color:#D33C08'></i></a></td>
