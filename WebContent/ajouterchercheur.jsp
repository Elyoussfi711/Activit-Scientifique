...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold"> <p style="color:Black;"><c:out value="${mdpInco1}"/></p></span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate"> <p style="color:Black;"><c:out value="${mdpInco1}"/></p></div>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Basic Information</h2></a></li>
                                
                            </ul>


                                                
                                                    <form action="<%=request.getContextPath()%>/ajouterchercheur" method="Post" enctype="multipart/form-data">
                                                    <p style="color:green;"><c:out value="${mdpInco}"/></p>
                                                        <div class="row">
                                                           
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                               
                                                                <div class="form-group">
                                                                    <input name="username" type="text" class="form-control" placeholder="Nom">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="tel" type="Telephone" maxlength="10" class="form-control" placeholder="Telephone">
                                                                </div>
                                                                 <div class="form-group">
                                                                 <lable>justificatif</lable>
                                                                    <input name="image" type="file" maxlength="10" class="form-control" >
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group ">
                                                                     <label>Profil</label>
                                                                     <br><br>
                                                                         <select name="profil" class="form-group col-lg-8" >
