             ...
             <li class="nav-item">
                ...
                <div id="collapseTwo7" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ajouterproject">Ajouter Des Projets</a>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="adminpage.jsp" class="nav-link">Home</a>
                                                </li>
...
<form action="<%=request.getContextPath()%>/updatesoutenance" method="Post">
                    
 <ul id="myTabedu1" class="tab-review-design">
                            
                                <li class="active"><a href="#"><h2>Soutenance</h2></a></li>
 ...
 <div class="form-group col-lg-6">
                                                                     <label>Type :</label>
                                                                     <br><br>
                                                                         <select name="type_sout" class="form-group col-lg-8" value="${home.type_sout}">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <label>Date Soutenance :</label>
                                                                    <input name="date" type="Date" class="form-control" value="${home.date}">
                                                                </div>
                                                                 <div class="form-group">
                                                                    <input name="initule" type="text" class="form-control" value="${home.initule}">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <input name="lieu" type="text" class="form-control" value="${home.lieu}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="jury" type="text" class="form-control" value="${home.jury}">
                                                                </div>
                                                                <div   class="form-group">
                                                                    <input name="description" type="text" class="form-control" value="${home.description}"></input>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                 <label>Justification :</label>
                                                                    <input name="justificatif" type="file" class="form-control" >
                                                                </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                                                 ...
                                                                                                 <div class="form-group">
                                                                         <input type="hidden" class="form-input" name="idactivites" id="name" value="${home.idactivitesc}"/>
