...
<head>
    <meta charset="utf-8">
    <title>activite pedagogique</title>
               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/activitepedagogiqueenseignant?username=${sessionScope.username}" method="Post"" method="Post">
                                  <h6>Type d'activité pédagogique :</h6>
                            <select name="activite_pedalogique" class="form-select mb-3" aria-label="Default select example">
