...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
    ...
    <div class="container emp-profile">
              <form action="<%=request.getContextPath()%>/updateprofilenseignant?idchercheur=${ntoma.idchercheur}" method="Post">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group ">
                                                                     <label>Activite Pedagogique :</label>
                                                                     </br>
                                                                         <select name="activite_pedagogique" class="form-group col-lg-8" value="${ntoma.activite_pedagogique}">
                                                                            <option >Responsable de Filière</option>
                                                                 ...
                                                                 <div class="form-group ">
                                                                     <label>Responsabiliter :</label>
                                                                     </br>
                                                                         <select name="responsabiliter" class="form-group col-lg-8" value="${ntoma.responsabiliter}">
                                                                         <option >Chef Equipe</option>
                                                                         <option >Chef Laboratoire</option>
                                                                         <option >Membre d'une conseil Etablissemant</option>
                                                                          <option >Membre Université</option>
                                                                         </select>
                                                                </div>
                                                                </br>
