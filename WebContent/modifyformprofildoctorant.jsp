...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
    ...
    <div class="container emp-profile">
              <form action="<%=request.getContextPath()%>/updateprofildoctorant?idchercheur=${ntoma.idchercheur}" method="Post" enctype="multipart/form-data">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                 ...
                                                                 <div class="form-group">
                                                                    <input name="image" type="file"  class="form-control" value="${ntoma.image}"/>
                                                                </div>
                                                                </br>
