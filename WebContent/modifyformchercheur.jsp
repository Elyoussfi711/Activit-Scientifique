...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Basic Information</h2></a></li>
                                                    ...
                                                    <form action="<%=request.getContextPath()%>/updateChercheur?idchercheur=${ntoma.idchercheur}" method="Post">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="tel" type="Text" maxlength="10" class="form-control" value="${ntoma.responsabiliter}"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="tel" type="Text" maxlength="10" class="form-control" value="${ntoma.activite_pedagogique}"/>
                                                                </div>
