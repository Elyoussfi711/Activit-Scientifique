               ...
               <ul class="nav navbar-nav mai-top-nav">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/publicationdoctorant?username=${sessionScope.username}" method="Post" enctype="multipart/form-data">
                                  
                             <h6>    </h6>
                                <h6>Titre Publication : </h6>
                                <input type="text" name="titre"  class="form-control" id="floating"
