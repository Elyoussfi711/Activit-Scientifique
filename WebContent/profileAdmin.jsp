            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ajouterlaboratoire">Ajouter Laboratoires</a>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p> (+212)0661532697 / 0661071208</p>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Ecole :</label>
                                            </div>
                                            <div class="col-md-6">
                                                <p>Bachelor , Genie Informatique</p>
                                            </div>
                                             <div class="col-md-6">
                                                <label>Ecole Adresse :</label>
                                            </div>
                                            <div class="col-md-6">
                                                <p>Université Moulay Ismaïl | Présidence, Marjane 2| BP:298, Meknes, MAROC</p>
                                            </div>
                                        </div>
