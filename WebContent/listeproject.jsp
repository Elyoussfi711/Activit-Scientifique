            ...
            <div id="content">
              ...
              <h3><strong><i><p style="color:#4d79ff"></br>
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <form action="<%=request.getContextPath()%>/listeaxeequipe" method="Post"> 
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                                 <tr>
                                  <c:forEach items="${listeproject}" var="prjt">
                                   <c:set var="count" value="${count + 1}" scope="page"/>
                                            ...
                                            <td>${prjt.budget}</td>
                                            <td>${prjt.duree}</td>
                                            <td>${prjt.description}</td>
                                            <td>${prjt.a_bstract}</td>
                                            
                                           
                                            
                                            <td>
                                               
                                            <a href="deleteproject?idactivitesc=<c:out value='${prjt.idactivitesc}'/>" ><i class='fas fa-trash-alt' style='font-size:20px;color:#D33C08'></i></a></td>
