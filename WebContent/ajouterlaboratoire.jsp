...
if(session.getAttribute("username")==null){ response.sendRedirect("LogIn.jsp");} %>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">vous avez ajouter une laboratoire</p></span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Juin 14, 2022</div>
                                       <strong>vous avez modifier une laboratoire</strong>
                                    </div>
                                </a>
 ...
 <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#"><h2>Laboratoire</h2></a></li>
                                
                            </ul>


                                                
                                                    <form action="<%=request.getContextPath()%>/ajouterlaboratoire" method="Post">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="nom_Labo" type="text" class="form-control" placeholder="Nom Laboratoire">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <input name="chef_Labo" type="text" class="form-control" placeholder="Chef Laboratoire">
                                                                </div>
